                ...
                <div className="space-y-4">
                  ...
                  {selectedMod ? (
                    <div className="flex h-full flex-col">
                      ...
                      <div className="mt-4 min-h-0 flex-1"><p className="text-xs font-semibold text-muted-foreground">说明</p><div className="mt-2 max-h-56 overflow-y-auto whitespace-pre-wrap rounded-lg bg-muted/30 p-3 text-xs leading-5 text-foreground/80">{selectedMod.description || '该模组没有 description.txt 或 readme.txt。'}</div></div>
                    </div>
